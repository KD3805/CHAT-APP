      ...
      <div className="w-full p-8 rounded-lg shadow-md bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-3xl bg-opacity-10 border border-gray-700">
        ...
        <form onSubmit={handleSubmit}>
          <div className="flex flex-col gap-1">
            ...
            <div className="my-2">
              <GenderRadioBtn onRadioChange={handleRadioChange} selectedGender={inputs.gender} />
            </div>
          ...
          <div>
            <button className="btn btn-outline btn-block btn-md mt-6 mb-3" disabled={loading}>
